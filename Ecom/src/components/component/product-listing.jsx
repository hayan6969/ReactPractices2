...
export function ProductListing() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        console.log("The data fetched is ", response.data.data.products);
        ...
        <div className="container grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-4">
            <h1 className="text-3xl md:text-4xl font-bold">
              The Art of Coding: A Beginner's Guide
            </h1>
          ...
          <div className="grid gap-8">
            <div>
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                ...
                euismod, nisl nec ultricies ultricies, nunc nisl ultricies nunc,
                nec ultricies nunc nisl nec nunc. Nullam auctor, nisl nec
                ...
                <div className="flex gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      This book is a great introduction to coding for beginners.
                      The author explains concepts clearly and provides
                      practical examples.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      learning to code. The author's teaching style is engaging
  ...
  return   <div key={product._id} className="group">
